...
import (
	...
	"github.com/dcproduct/action/ch7/patterns/pool"
)

const (
	maxGoroutines  = 25 // the number of routines to use.
	pooledResoures = 2  // number of resources in the pool
)
...
func main() {
	...
	// Create the pool to manange our connections.
	p, err := pool.New(createConnection, pooledResoures)
	if err != nil {
		log.Println(err)
	}
